...
* **output_log_path** (*string*): Path to the output Tritration log file LOG. File type: output. [Sample file](None). Accepted formats: LOG
...
#### Command line
```python
titration --config config_titration.yml --input_pdb_path 1kim_h.pdb --output_pdb_path 1kim_neutral.pdb --output_log_path output.log --input_vdw_params_path input.txt --input_params_path input.txt
```
### JSON
...
#### Command line
```python
titration --config config_titration.json --input_pdb_path 1kim_h.pdb --output_pdb_path 1kim_neutral.pdb --output_log_path output.log --input_vdw_params_path input.txt --input_params_path input.txt
```
...
Config parameters for this building block:
* **execution_type** (*string*): (mip) Default options for the params file. Each one creates a different params file. .
* **params** (*object*): ({}) CMIP options specification..
...
#### Command line
```python
cmip --config config_cmip_mip.yml --input_pdb_path 1kim_h.pdb --input_probe_pdb_path input.pdb --output_pdb_path 1kim_neutral.pdb --output_grd_path output.grd --output_cube_path output.cube --output_rst_path output.txt --output_byat_path output.txt --input_vdw_params_path input.txt --input_params_path input.txt
```
### JSON
...
#### Command line
```python
cmip --config config_cmip_mip.json --input_pdb_path 1kim_h.pdb --input_probe_pdb_path input.pdb --output_pdb_path 1kim_neutral.pdb --output_grd_path output.grd --output_cube_path output.cube --output_rst_path output.txt --output_byat_path output.txt --input_vdw_params_path input.txt --input_params_path input.txt
```
