...
htmlhelp_basename = 'biobb_cmip_doc'
...
latex_documents = [
    (master_doc, 'biobb_cmip.tex', u'biobb_cmip Documentation',
...
man_pages = [
    (master_doc, 'biobb_cmip', u'biobb_cmip Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'biobb_cmip', u'biobb_cmip Documentation',
     author, 'biobb_cmip', 'biobb_cmip molecular dynamics building blocks',
     'Miscellaneous'),
]
